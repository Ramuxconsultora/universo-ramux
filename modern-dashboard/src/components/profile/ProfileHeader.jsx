...
import { User, Shield, Award, Zap, Star } from 'lucide-react';
import GlassPanel from '../ui/GlassPanel';

const ProfileHeader = ({ user, rank = "Analista", level = 12 }) => {
        ...
        <div className="space-y-6 animate-slide-up">
            <div className="flex flex-col lg:flex-row items-center gap-8 bg-slate-900/40 p-10 rounded-[2.5rem] border border-white/5 backdrop-blur-3xl relative overflow-hidden group">
                ...
                <div className="relative">
                    <div className="w-32 h-32 rounded-full bg-slate-800 border-2 border-sky-500/50 p-1.5 shadow-[0_0_30px_rgba(14,165,233,0.2)]">
                ...
                <div className="flex-grow text-center lg:text-left space-y-4">
                    <div className="space-y-1">
                        <div className="flex flex-wrap justify-center lg:justify-start items-center gap-3">
                            ...
                            <span className={`px-4 py-1 rounded-full border font-black text-[10px] uppercase tracking-widest ${getRankColor()}`}>
                                {rank}
                            </span>
                        </div>
                ...
                <div className="flex gap-3 bg-white/5 p-4 rounded-3xl border border-white/5">
                    ...
                    <div className="w-12 h-12 rounded-2xl bg-slate-900/50 border border-dashed border-white/10 flex items-center justify-center text-slate-600 text-[10px] font-black">
                        +8
                    </div>
                </div>
            </div>
