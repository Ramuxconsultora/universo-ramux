                    ...
                    <div className="flex flex-col items-center group/orbits -translate-y-[23px]">
                        <div className="w-24 h-24 md:w-32 md:h-32 relative">
                            <svg
                                ...
                                strokeWidth="1.2"
                            >
                                {/* Incandescent Orange World - Optimized (no filter) */}
                                <circle
                                    cx="50" cy="50" r="4.5"
                                    fill="#F76B1C"
                                ...
                                {/* Fibonacci Orbit 1 (Inner) - Simplified */}
                                <g className="origin-center animate-spin-slow-reverse" style={{ animationDuration: '6s' }}>
                                    <circle
                                        cx="50" cy="50" r="15"
                                ...
                                {/* Fibonacci Orbit 2 (Middle) - Simplified */}
                                <g className="origin-center animate-spin-slow-reverse" style={{ animationDuration: '10s' }}>
                                    <circle
                                        cx="50" cy="50" r="26"
                                ...
                                {/* Fibonacci Orbit 3 (Outer) - Simplified */}
                                <g className="origin-center animate-spin-slow-reverse" style={{ animationDuration: '16s' }}>
                                    <circle
                                        cx="50" cy="50" r="38"
                        ...
                        <span className="text-[10px] md:text-[11px] uppercase tracking-[0.2em] text-white/20 group-hover/card:text-sky-300 transition-all duration-300 font-bold mt-1 text-center whitespace-nowrap cursor-default">
                            Órbita de Fibonacci
                        </span>
                    </div>
                </div>
